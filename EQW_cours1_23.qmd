...
subtitle: "Prise en main du logiciel et premières analyses"
date: "last-modified"
author:
  name: Sophie Balech
...
data%>%group_by(year)%>%summarise(n=n(), prop=n/nrow(data))%>%
...
textplot_wordcloud(dfm_trim, max_words = 100, color = rev(brewer.pal(10, "Spectral")))
